...
Blockly.Msg.OTTO9_BATVOLT_TEXT = 'battery voltage ';
Blockly.Msg.OTTO9_BATLEVEL_TEXT = 'battery level as a percentage ';
Blockly.Msg.OTTO9_BATTERY_TOOLTIP = 'read the battery voltage';
...
Blockly.Msg.OTTO9_GETTOUCHED_TEXT = '(touch < 500)';
Blockly.Msg.OTTO9_GETTOUCHED_TOOLTIP = 'Returned True if touch is < 500';
Blockly.Msg.OTTO9_GETG_TEXT = 'motion';
Blockly.Msg.OTTO9_MOUTH_TEXT = 'mouth';
Blockly.Msg.OTTO9_MOUTH_NUM_TEXT = 'mouth display #';
Blockly.Msg.OTTO9_MOUTH_TOOLTIP = 'mouth emotion for the 8x8 LED matrix #0-30';
Blockly.Msg.OTTO9_MOUTH_CHOICE = [['😃 happy1', 'happyOpen'], ['🙂 happy2', 'happyClosed'], ['😊 smile', 'smile'], ['😦 sad1', 'sadOpen'], ['🙁 sad2', 'sadClosed'], ['😮 surprise', 'smallSurprise'], ['😲 Surprise2', 'bigSurprise'], ['😕 confused', 'confused'], ['😛 tongue', 'tongueOut'], ['🙃 silly', 'culito'], ['😑 serious', 'lineMouth'], ['🙄 upset', 'diagonal'], ['💖 heart', 'heart'], ['🦇 v1', 'vamp1'], ['🦇 v2', 'vamp2'], ['❌ no', 'xMouth'], ['✅ OK', 'okMouth'], ['❓?', 'interrogation'], ['⚡ thunder', 'thunder']];
...
Blockly.Msg.OTTO9_MATRIX_TOOLTIP = 'limited to CAPITALS A to Z NUMBERS 0 to 9 : ; < > : @, max.19 characters';
...
Blockly.Msg.OTTO9_INIT_TEXT = 'Init';
Blockly.Msg.OTTO9_INIT_LEG = 'Leg:';
Blockly.Msg.OTTO9_INIT_FOOT = 'Foot:';
Blockly.Msg.OTTO9_INIT_ARM = 'Arm:';
Blockly.Msg.OTTO9_INIT_CALIBRATE = 'Load Cal:';
Blockly.Msg.OTTO9_INIT_NOISE = 'Noise:';
Blockly.Msg.OTTO9_INIT_BUZZER = 'Buzzer:';
Blockly.Msg.OTTO9_INIT_ECHO = 'Echo:';
Blockly.Msg.OTTO9_INIT_TRIGGER = 'Trigger:';
Blockly.Msg.OTTO9_INIT_TOOLTIP = 'Initialize Otto select the pins for your Otto';
